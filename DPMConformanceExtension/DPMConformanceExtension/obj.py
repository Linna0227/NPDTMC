...
class ProcessTree(object):
    ...
    def __init__(self, operator=None, parent=None, children=None, label=None, uid=None, priority=None, layer=None, act_set=None):
        """
        Constructor
        ...
        self._layer = layer
        self._act_set = set() if children is None else act_set
    ...
    def _get_act_set(self):
        return self._act_set

    def _set_act_set(self, act_set):
    ...
    act_set = property(_get_act_set, _set_act_set)
